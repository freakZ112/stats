const fum_url = "https://scripts.drtraxx.de", /* live */
//const fum_url = "http://localhost/www/scrpts.drtraxx", /* dev */
...
(async function () {
    ...
    await $.getScript(`${ fum_url }/fuhrparkmanager/modal.js?${ fum_datestring }`);
    await $.getScript(`${ fum_url }/fuhrparkmanager/initial_functions.js?${ fum_datestring }`);
    await $.getScript(`${ fum_url }/fuhrparkmanager/onclick.js?${ fum_datestring }`);
})();
